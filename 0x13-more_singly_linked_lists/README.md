...
File lists.h is the header file containing all these function prototypes and the data structure listint_tFile 0-print_listint.c is a function that prints all the elements of a listint_t list.
